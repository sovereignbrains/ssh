...
(function(root){
  const COLLECTIONS=['sessions','keys','tunnels','projects','secrets'];
  ...
  function describe(stats){
    const words={sessions:['сессия','сессии','сессий'],keys:['ключ','ключа','ключей'],tunnels:['проброс','проброса','пробросов'],projects:['проект','проекта','проектов'],secrets:['секрет','секрета','секретов']};
