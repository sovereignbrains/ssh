...
const JTYPES={claude:'Claude',sftp:'SFTP',connect:'Подключение',disconnect:'Отключение',hostkey:'Ключ хоста',key:'Ключи',tunnel:'Проброс',local:'Локальный shell',vault:'Сейф',project:'Проект',secret:'Секрет'};
